...
class ESB_Cost extends \Elementor\Widget_Base
{
	...
	public function get_title()
	{
		...
		return __('Cost', 'mec-single-builder');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => 'left',
				'selectors' => [
					'{{WRAPPER}} .mec-event-cost' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' 	=> [
					'{{WRAPPER}} .mec-event-cost i:before' => 'font-size: {{SIZE}}{{UNIT}} !important;',
                    '{{WRAPPER}} .mec-event-cost img' => 'width: {{SIZE}}{{UNIT}} !important;height: {{SIZE}}{{UNIT}} !important;',
                ],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> ['px', 'em', '%'],
				'selectors' 	=> [
					'{{WRAPPER}} .mec-event-cost dd' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		$atts = array(
			'mec_cost_show_title' => isset( $settings['mec_cost_show_title'] ) && 'yes' === $settings['mec_cost_show_title'] ? true : false,
			'mec_cost_show_icon' => isset( $settings['mec_cost_show_icon'] ) && 'yes' === $settings['mec_cost_show_icon'] ? true : false,
		);


		echo \MEC\SingleBuilder\SingleBuilder::getInstance()->output( 'event-cost' ,0 ,$atts );
	}
}
