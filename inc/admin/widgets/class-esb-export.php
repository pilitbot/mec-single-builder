...
class ESB_ExportModule extends \Elementor\Widget_Base {
	...
	public function get_title() {
		...
		return __( 'Export', 'mec-single-builder' );
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' 	=> [ 'px', 'em', '%' ],
					'selectors' 	=> [
						'{{WRAPPER}} .mec-event-exporting .mec-export-details ul li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'toggle' => true,
					'selectors' 	=> [
						'{{WRAPPER}} .mec-event-exporting .mec-export-details ul li' => 'text-align: {{VALUE}} !important;',
					],
				]
			);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> \Elementor\Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} a.mec-events-button:hover' => 'color: {{VALUE}} !important',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> \Elementor\Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} .mec-events-button:hover' => 'background: {{VALUE}} !important',
				],
			]
		);
